...
![H1](./newres/image/w9/H1.png){.w-190}

![H1A](./newres/image/w9/H1A.png){.w-190}

---

# T2

![H2](./newres/image/w9/H2-1.png){.w-190}
![H2](./newres/image/w9/H2-2.png){.w-190}
...
$$
T_{avg\ rotation} = \frac{1}{2}\times  T_{max\ rotation} = \frac{1}{2}\times \frac{1}{RPM}\times \frac{60000 ms}{1 min} = 2ms
$$
$$
T_{avg\ transfer} = \frac{1}{RPM}\times  \frac{60000 ms}{1 min} \times \frac{1}{1000} = 0.004ms
$$

</div>
2MB 的文件需要 4000 个 512 字节的逻辑块。
A. 只需要移动一次读写头。
...
![H2](./newres/image/w9/H3-1.png){.w-100}
![H2](./newres/image/w9/H3-2.png){.w-100}
...
![H2](./newres/image/w9/H3-3.png){.w-100}
![H2](./newres/image/w9/H3.png){.w-100}
...
![H2](./newres/image/w9/H3-4.png){.w-100}
![H2](./newres/image/w9/H3.png){.w-100}
...
![H2](./newres/image/w9/H3-5.png){.w-100}
![H2](./newres/image/w9/H3-1.png){.w-100}
...
![H2](./newres/image/w9/H4-1.png){.w-100}



::right::

![H2](./newres/image/w9/H4-2.png){.w-100}
![H2](./newres/image/w9/H4-3.png){.w-100}
...
![H2](./newres/image/w9/H4-4.png){.w-200}
![H2](./newres/image/w9/H4-5.png){.w-200}
...
![image-51](./newres/image/W9/E5-1.png)
...
![image-52](./newres/image/W9/E5-2.png){.w-120}
...
![E5-A1](./newres/image/W9/E5-A1.png){.w-130}
...
![image-53](./newres/image/W9/E5-3.png){.w-150}
...
![E5-A2](./newres/image/W9/E5-A2.png){.w-150}
...
![image-61](./newres/image/W9/E6-1.png){.w-100}
...
![image-62](./newres/image/W9/E6-A1.png){.w-100}
![image-62](./newres/image/W9/E6-A2.png){.w-100}
...
![image-62](./newres/image/W9/E6-2.png){.w-110}
![image-53](./newres/image/W9/E6-3.png){.w-110}
...
![image-62](./newres/image/W9/E6-A3.png){.w-150}
...
![image-71](./newres/image/W9/E7-1.png){.w-150}
...
![image-71](./newres/image/W9/E7-2.png){.w-150}
...
![image-71](./newres/image/W9/E7-3.png){.w-150}
...
![image-7A](./newres/image/W9/E7-A.png){.w-150}
