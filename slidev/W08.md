...
- 本章内容极多，细节多，自仔细读书
- 对于 SEQ、PIPE 的实现、线是怎么连接的，信号是怎么产生、在什么时候产生的，都需要完全理解、熟练掌握
- 对于冲突的解决，也需要完全理解、熟练掌握
- 参考资料： [CMU / HCL Descriptions of Y86-64 Processors](https://csapp.cs.cmu.edu/3e/waside/waside-hcl.pdf)，Y86-64 指令集，HCL 完整版
- 建议基于可以搜集到的所有资料，用自己的方式好好整理一遍（笔头/电子/脑中）
...
![image-20231025022538498](./newres/image/w8/h1.png)
<br>

![image-20231025022538498](./newres/image/w8/hw1.png){.w-72}
...
::left::
![image-20231025022538498](./newres/image/w8/h2.png){.w-100}
...
![image-20241023091221902](./newres/image/w8/T1-1.png)

</div>
<div>

![image-20241023091238133](./newres/image/w8/T1-2.png)

</div>
<div>

![image-20241023091304981](./newres/image/w8/T1-3.png)
...
![image-20241023102131229](./newres/image/w8/T1-4.png){.w-90}
...
![image-20241023102254400](./newres/image/w8/T1-5.png)
...
- 往年补充资料： [pipelined res.pdf](https://github.com/Yaenday/WalkerCH-ICS-Slides/blob/main/res/document/pipelined%20res.pdf) 
